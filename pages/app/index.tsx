    ...
    <>
      {/* <div>
        ...
        >
          {sliderData.map((e) => (
            <SwiperSlide>
              <div className='w-full h-screen max-h-xl relative'>
                <Image className='z-10' src={e.img} layout='fill' />
                <div className='mx-20 absolute bottom-36 z-20'>
                  <div
                  ...
                  <div
                    className='text-2xl py-2 font-serif italic'
                    style={{
                      color: e.titleColor
                    }}
                  >
